    ...
    object domain {
      ...
      object markers {
        ...
        def iterator: Iterator[CategoryMarker] = {
          val jcoll = peer.getDomainMarkers(Layer.Foreground).asInstanceOf[util.Collection[CategoryMarker]]
    ...
    object range {
      ...
      object markers {
        ...
        def iterator: Iterator[Marker] = {
          val jcoll = peer.getRangeMarkers(Layer.Foreground).asInstanceOf[util.Collection[Marker]]
          jcoll.iterator.asScala
        }
      }
    }
  ...
  implicit class RichXYPlot(val peer: XYPlot) {
    object domain {
      ...
      object markers {
        ...
        def iterator: Iterator[Marker] = {
          val jcoll = peer.getDomainMarkers(Layer.Foreground).asInstanceOf[util.Collection[Marker]]
          jcoll.iterator.asScala
        }
      }
    }
